...
C:\Windows\system32>cd jeky11-theme-next
系统找不到指定的路径。
````
...
![WechatIMG10](https://acq7line.github.io/upload_img/WechatIMG10.png)

最后成功的话就显示：Bundle complete!

![WechatIMG20](https://acq7line.github.io/upload_img/WechatIMG20.png)
...
list 挺长的，这里举个例子，concurrent-ruby 有两个版本，就…删呗
![WechatIMG45](https://github.com/acq7line/acq7line.github.io/raw/main/upload_img/WechatIMG45.jpeg)
